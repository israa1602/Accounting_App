    ...
    render() {
        return (
            <div>
                ...
                <p align="center" id="copy" className="uk-padding-small uk-light uk-margin-remove">Copyright &copy; <i><Link to="/">Full design</Link><br/><small className="uk-text-muted">Powered by <img src={react} width="25px" alt="" /></small></i></p>
            </div>
        )
    }
}
